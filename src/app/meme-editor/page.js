        ...
        <div className="textSec">
          <div>
            <input
              ...
              onChange={(e) => setDisplayText01(e.target.value)}
            />
            <input
              type="number"
              placeholder="Text 1 Size"
              onChange={(e) => setFontSize01(e.target.value + "px")}
            />
          </div>
        ...
        <div className="textSec">
          <div>
            <input
              ...
              onChange={(e) => setDisplayText02(e.target.value)}
            />
            <input
              type="number"
              placeholder="Text 1 Size"
              onChange={(e) => setFontSize02(e.target.value + "px")}
            />
          </div>
